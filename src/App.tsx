        ...
        <>
            ...
            <Container style={{fontFamily: selectedTheme.font}}>
                <div className='App flex-column flex align-items-center justify-content-center w-full'>
                    <div
                        className='App-header absolute top-0 flex-row flex align-items-center justify-content-center w-full max-w-full gap-1'>
                        <h1 className="flex-grow-1 font-bold flex text-left px-4 w-full">Austin Rizer</h1>
                        <h3 className="flex-shrink-0 font-italic flex text-center px-5 w-auto">Software Developer,
                            Salesforce Engineer, Photographer</h3>
                    </div>
                    <div
                        className='App-body flex-row flex-grow-1 flex align-items-start justify-content-between gap-4 w-full max-w-full p-4 mt-6'>
                        ...
                        <div className='profile-section flex-column flex align-items-center w-4 md:w-3'>
                            ...
                            <div className='bio-section p-3 border-round-xl shadow-2'>
                                ...
                                <p className='line-height-3 text-justify'>
                                    Hello! I'm Austin Rizer, a passionate software developer and Salesforce engineer
                                    with a
                                    background in photography. I specialize in building efficient, user-friendly
                                    applications
                    ...
                    <div
                        className='footer absolute bottom-0 flex-row flex w-full max-w-full gap-1 align-content-center'>
                        <div
                            className='socialIcons absolute right-0 mr-4 mb-6 flex align-items-center justify-content-center gap-2'
                            style={{color: 'var(--indigo-500'}}>
                            <a className='pi pi-github cursor-pointer' style={{fontSize: '1.5rem'}}
                               href={'https://github.com/aggartman'} target="_blank" rel="noopener noreferrer"></a>
                            <a className='pi pi-linkedin cursor-pointer' style={{fontSize: '1.5rem'}}
                               href={'https://www.linkedin.com/in/austinrizer/'} target="_blank"
